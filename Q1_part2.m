...
%  Squared Euclidean Distances for dataset B
% WARNING! This program takes hours! (Use my published version)
clc
clear all 
...
% 58 features
% We get 205,202,203,192,195,201,209,186,211,196 samples for classes
% C1 to C10(0)
for i = 1:row
    if Data_A(i,1)==1
...
temp = 0;
ind = 0;
% Selecting our features using (SFS);
% TAKES TIME!(You may use the Published version)
% We selesct first 20 features that has more distance from others..
